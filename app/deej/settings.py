# Django settings for deej project.
...
PIPELINE_CSS = {
    'deej_css': {
        'source_filenames': (
            'stylesheets/jquery-ui/jquery-ui-1.8.16.custom.css',
            'stylesheets/app.css'
        ),
        'output_filename': 'stylesheets/deej.min.css',
    },
}
...
PIPELINE_JS = {
    'deej_js': {
        'source_filenames': (
            ...
            'javascripts/contrib/jquery.serializeObject.min.js',
            'javascripts/deej.js',
        ),
        'output_filename': 'javascripts/deej.min.js',
    },
    'modernizr_js': {
        'source_filenames': (
...
SECRET_KEY = 'make_this_a_unique_key_in_your_local_settings_duh'
...
ROOT_URLCONF = 'deej.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'deej.wsgi.application'
...
LOGIN_URL = "/login/"
LOGIN_REDIRECT_URL = '/'
SOUNDKICK_URL = 'http://localhost:8080/'
